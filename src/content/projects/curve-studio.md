...
**CurveStudio** is an interactive educational tool built for the **Swift Student Challenge 2026**. It provides a playground environment where users can visually explore and manipulate mathematical curves — functions, derivatives, Riemann sums — turning abstract equations into something you can see and interact with.
